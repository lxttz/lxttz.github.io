...
function showWelcome() {
  // 安全检查:确保ipLoacation已加载且包含必要数据
  if (!ipLoacation || !ipLoacation.result || !ipLoacation.result.location || !ipLoacation.result.ad_info) {
    console.log('IP定位数据未加载,使用默认欢迎信息');
    return;
  }
...
<h2>二、字体设置</h2>
<div style="background-color: #fff7cc; border-left: 4px solid #ffc107; padding: 12px; margin: 10px 0; border-radius: 4px;">
  <strong style="color: #856404;">⚠️ 注意:</strong> 非商免字体未经授权只能个人使用。本站为完全非商业、非盈利性质的网站，平时用于个人学习交流，如有侵权请联系站长删除，谢谢！ —— 致版权方
</div>
<p id="swfs">
...
<h3>1. 二次元</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看二次元背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
      ...
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/fj2.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mc2.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mc2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/fj3.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj3.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mc3.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mc3.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb1.webp)')"></a>
    </div>
  </div>
</div>
...
<h3>2. 风景</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看风景背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
      ...
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/fj2.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/fj3.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj3.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb2.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb3.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb3.webp)')"></a>
    </div>
  </div>
</div>
...
<h3>3. 萌宠</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看萌宠背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
      ...
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mc2.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mc2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mc3.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mc3.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb4.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb4.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb5.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb5.webp)')"></a>
    </div>
  </div>
</div>
...
<h3>4. 渐变色</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看渐变色背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
...
<h3>5. 纯色</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看纯色背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
...
<h3>6. 适配手机</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看适配手机的背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb1.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb1.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb2.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb2.webp)')"></a>
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb3.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb3.webp)')"></a>
      ...
      <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb5.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mb5.webp)')"></a>
    </div>
  </div>
</div>
...
<h3>7. 壁纸API</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">查看壁纸API系列背景</summary>
  <div class="toggle-content">
    <div class="bgbox">
      <a id="bingDayBox" rel="noopener external nofollow" style="background-image: ${bingDayBg}" class="box apiBox" onclick="changeBg('${bingDayBg}')" title="必应每日壁纸"></a>
      <a id="bingHistoryBox" rel="noopener external nofollow" style="background-image: ${bingHistoryBg}" class="box apiBox" onclick="changeBg('${bingHistoryBg}')" title="必应历史壁纸"></a>
      <a id="EEEDogBox" rel="noopener external nofollow" style="background-image: ${EEEDog}" class="box apiBox" onclick="changeBg('${EEEDog}')" title="EEEDog"></a>
      <a id="seovxBox" rel="noopener external nofollow" style="background-image: ${seovx}" class="box apiBox" onclick="changeBg('${seovx}')" title="Seovx"></a>
      <a id="picsumBox" rel="noopener external nofollow" style="background-image: ${picsum}" class="box apiBox" onclick="changeBg('${picsum}')" title="Picsum"></a>
      <a id="waiBizhiBox" rel="noopener external nofollow" style="background-image: ${waiBizhi}" class="box apiBox" onclick="changeBg('${waiBizhi}')" title="小歪壁纸"></a>
      <a id="btstuBox" rel="noopener external nofollow" style="background-image: ${btstu}" class="box apiBox" onclick="changeBg('${btstu}')" title="博天壁纸"></a>
      <a id="unsplashBox" rel="noopener external nofollow" style="background-image: ${unsplash}" class="box apiBox" onclick="changeBg('${unsplash}')" title="Unsplash"></a>
    </div>
  </div>
</div>
...
<h3>8. 自定义背景</h3>
<div class="toggle" style="border: 1px solid cyan;">
  <summary class="toggle-button" style="background-color: cyan;">设置自定义背景</summary>
  <div class="toggle-content">
    <p><center>
